language_Simplified_Chinese() {
    ...
    ; ydTrans.ahk
    global lang_yd_translating := "翻译中💪，😀感谢OwO-Network/DeepLX搭建的白嫖接口"
    global lang_yd_name := "DeepL翻译"
    ...
    ( LTrim
        ...
        ;Math Board（Caps+F2）的小键盘按键映射规则：
        ;1：仅当 CapsLock 逻辑开启时，字母键才映射为数字（默认，为 V1 行为）
        ;0：Math Board 打开后总是映射（为 V2 重构后行为）
