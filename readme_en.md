...
Since the original translation interface (Baidu Translate) was consistently unavailable, with the help of Google-Gemini, the translation interface was modified to the free version (DeepL) interface, and in the process, I also set up my own [DeepLX Powerful DeepL Translation API](https://deeplx.owo.network).

- I am limited in my ability to offer the same selection configurations as the original author, as the files have already been pre-configured with my own self-built [DeepLX](https://zhjwork.online/2024/04/30/deeplx%e7%99%bd%e5%ab%96%e6%9c%8d%e5%8a%a1/) service. Users can utilize it directly.
- Additionally, I have modified the translation window, adding a scrollbar for long paragraph translations.

**Once again, I would like to express my gratitude to Google-Gemini and DeepLX for their selfless contributions**
